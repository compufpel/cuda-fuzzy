...
% O trabalho - Acredito que deverÃ¡ ser melhor explorado esta parte! Quando os objetivos ficarem mais claros %	
...
\label{sec:trabalhos}
	...
	Nesse trabalho foi implementado a biblioteca CudaFuzzy, nele foram realizados testes com operadores matemáticos da lógica Fuzzy. O objetivo do trabalho foi obter uma implementação que consiga paralelisar as aplicações desenvolvidas na biblioteca CudaFuzzy, e assim obter melhor desempenho computacional com uso dessa biblioteca de operações direcionada para GPUs. 
