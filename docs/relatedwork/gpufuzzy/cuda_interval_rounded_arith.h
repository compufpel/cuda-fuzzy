...
struct rounded_arith<float>
{
    ...
    __device__ float eps() {
        return __int_as_float(0x33800000);
    }

    __device__ float eta() {
        return __int_as_float(0x00000001);
    }
...
struct rounded_arith<double>
{
    ...
    __device__ double eps() {
        return __longlong_as_double(0x3ca0000000000000ull);
    }

    __device__ double eta() {
        return __longlong_as_double(0x0000000000000001ull);
    }
